...
public class ExternalDbOpenHelper extends SQLiteOpenHelper {
    ...
    private static String DB_PATH = "/data/data/com.example.zapal.myapplication/databases/";

    private static String DB_NAME = "bus.sql";
    ...
    // to you to create adapters for your
}